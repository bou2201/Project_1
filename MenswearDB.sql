...
insert into Menswears(menswear_name, menswear_description, menswear_brand, menswear_material, menswear_price, category_id) values 
			('Polo', 'Vest collar, soft, masculine, luxurious silk material, with logo on the left chest.', 
					'ONTOP', 'cotton', '249000', 1),
			('Polo', 'The shirt has a cool fabric, the slim-fit form fits snugly and flatters the figure.', 
					'DAVIES', 'cotton', '199000', 1),
			('Polo', 'The shirt has detailed leather pockets on the chest to create accents, respecting the wearer figure.', 
					'COOLMATE', 'cotton', '199000', 1),
			('Plaid Shirt', '97% cotton, 3% spandex, soft fabric, medium stretch, durable quality no need to last long.', 
					'SSSTUTTER', 'cotton', '289000', 1),
			('Sport Shirt', 'Shirt used for activities, gym or daily wear, smooth fabric, not hot, stable elasticity.', 
					'COOLMATE', 'cotton', '259000', 1),
			('Short-sleeved Shirt', 'Super soft fabric, this fitted shirt features a button-down collar.', 
					'COOLMATE', 'cotton', '199000', 1),
			('T-Shirt', '180gsm round spun cotton t-shirt, round collar, Jersey neckband.', 
					'SSSTUTTER', 'cotton', '199000', 1),
			('T-Shirt', 'Short-sleeve round-neck T-shirt with good absorbency to bring comfort to the wearer, featuring the goddess Victorya on the front.',
					'COOLMATE', 'cotton', '199000', 1),
			('T-Shirt', 'Short-sleeved round-neck t-shirt brings youthfulness and dynamism, printed with a lovely artistic baby image with interesting expressions.',
			...
			('Plaid T-Shirt', 'Breathable material shirt, collar with buttons all around, two chest pockets with one button closure on each pocket.',
					'SSSTUTTER', 'cotton', '199000', 1),
			('Tanktop', 'Short-sleeved round neck shirt brings strength and coolness, with logo on the left corner of the shirt.',
					'COCCACH', 'cotton', '149000', 1),
			('Tanktop', 'Round neck short sleeve top, designed with high quality soft, stretchy mesh fabric. ',
					'SSSTUTTER', 'cotton', '149000', 1),
			('Tanktop', 'A sleeveless tank top with Nirvana print on the chest, woven stamps adorning the armpit hem.',
					'DOCMENSWEAR', 'synthetic fabric', '149000', 1),
			('Blazer', 'Collared shirt, simple design, wide form, suitable for many body shapes, concealer.',
					'ZARA', 'mixed wool', '739000', 1),
			('Blazer', 'The jacket is made of soft, breathable and lightweight fabric. Short body with simple design, wide form, suitable for many body shapes, creating a youthful and dynamic appearance. ',
					'H2T', 'flannel fabric', '639000', 1),
			('Blazer', 'The loose-fitting shirt without shoulder straps makes it comfortable to wear, easy to operate, and easy to combine with a variety of clothes.',
					'TORANO', 'raw cloth', '639000', 1),
			('Kaki', 'Flat front and elasticated back, side seam pockets, tapered with shirt tail detail at leg hem.',
					'COCCACH', 'cotton', '405000', 2),
			('Kaki', 'The pants are super durable, super soft, not afraid of losing their form when left in the closet for a long time, creating a unique and unique personality.',
					'5THEWAY', 'cotton', '405000', 2),
			('Jogger', 'The pants are designed with two-pipe, heat-insulating, two zippered back pockets to keep your valuables safe.',
					'5THEWAY ', 'cotton', '249000', 2),
			('Jogger', 'The pants are designed to be soft with two tubes, good insulation, and have 2 zippered back pockets to keep valuables safe.',
					'5THEWAY', 'cotton', '349000', 2),
			('Jean', 'Pants with elastic waistband, size zip pocket and gold trim on the outside leg, casual, classy.',
					'ONTOP', 'cotton, spandex','342000', 2),
			('Jean', 'Blue pants. Low floor. Fading, patchy, and painful throughout. Five-pocket design. Belt loop at the waistband. Signature embroidered detail in off-white color on the back pocket, flatters the wearer figure. ',
					'COOLMATE', 'cotton', '468000', 2),
			('Short', 'Garments are dyed & washed with enzymes, subject to slight variation in colour. Ribbed elastic waistband with slotted drawstring, side pockets.',
					'DIRTY COINS', 'cotton', '249000', 2),
			('Short Jean', 'Brown stitched pants, hip and back pockets. Zip/button front front, high waist for a snug fit.',
					'SSSTUTTER', 'cotton', '249000', 2),
			('Short Kaki', 'Pants designed for style, comfort. Flat zip pockets, sophisticated branding and durable drawstring waistband.',
